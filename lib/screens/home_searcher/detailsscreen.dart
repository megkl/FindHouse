...
class DetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
              ...
              height: MediaQuery.of(context).size.height * .6,
                ...
                itemBuilder: (context, index) {
                  return Image.network(
                    propertyNotifier.currentProperty.roomImages[index] != null ? propertyNotifier.currentProperty.roomImages[index] : "https://firebasestorage.googleapis.com/v0/b/drinkapp-16c27.appspot.com/o/propertiesf%2Fimages%2F4614aa24-54a2-41d5-a308-2f6f995a60ce.jpg?alt=media&token=bb8d0a13-ba12-4780-8e73-70f860a2c53e",
                    fit: BoxFit.cover,
          );
        },
      ),
                         ...
                         child: Column(
                             ...
                             children: <Widget>[
                                   ...
                                   SizedBox(
                                     ...
                                     child: GoogleMap(
                                       ...
                                       initialCameraPosition: CameraPosition(
                                           target: LatLng(propertyNotifier.currentProperty.map.latitude,propertyNotifier.currentProperty.map.longitude ), zoom: 14),
                                       markers: _markers,
                               ...
                               Padding(
                                 ...
                                 child: Wrap(
                                     children: <Widget>[
                                 ...propertyNotifier.currentProperty.features.map(
                                         (feature) {
                                       return Container(
    ...
    Align(
                ...
                child: Row(
                  ...
                  children:<Widget>[
                    Icon(
                        ...
                        Text("${propertyNotifier.currentProperty.price}/", style: TextStyle(color: Colors.white),),
        ...
        child: RaisedButton(
        onPressed: () {
      customLaunch('tel:${propertyNotifier.currentProperty.sellerPhoneNumber}');
    },
